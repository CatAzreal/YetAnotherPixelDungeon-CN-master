...
import com.consideredhamster.yapdcn.visuals.sprites.MimicSprite;
    ...
    protected boolean act() {
        ...
        if (heap != null && heap.type == Heap.Type.HEAP && !enemySeen) {
            ...
            if (Dungeon.visible[pos]) {
                GLog.w("宝箱怪正躺在地板上模仿着 %s ！", item.toString());
            }
...
//            return true;
	...
	public String description() {
		return
			"宝箱怪是一种可以随心所欲变成任何形状的魔法生物。它们知道如何勾引冒险者前来，然而自己速度太慢逮不到他们，所以在地牢里它们总是会变成一种宝箱的样子等人上钩。";
	}
